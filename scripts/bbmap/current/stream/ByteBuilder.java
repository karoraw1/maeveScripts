...
public final class ByteBuilder implements Serializable {
	...
	public ByteBuilder append(float x, int places){return append(String.format(Locale.ROOT, "%."+places+"f", x));}
	public ByteBuilder append(double x, int places){return append(String.format(Locale.ROOT, "%."+places+"f", x));}
